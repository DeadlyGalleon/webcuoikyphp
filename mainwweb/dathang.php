...
<td class="shoping__cart__total" data-product-id="<?php echo $sanphamgiohang->getIdsanphamgh() ?>">
        <?php echo $sanphamgiohang->getThanhtiengh() ?> VNĐ
            ...
            <form action="../control/dathang.php" method="post">
                <div class="form-group">
                    <label for="phone">Số điện thoại</label>
                    <input value="<?php echo $taikhoan->getsodienthoai() ?> " type="text" class="form-control" id="phone" name="sodienthoai" required>
                </div>
                <div class="form-group">
